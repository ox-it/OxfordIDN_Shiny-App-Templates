...
<iframe src=https://trainingidn.shinyapps.io/shiny-template_popout-button/?allowPopout=true width="100%" height="500px"></iframe>
...
- [Pulsating loading pane](https://martinjhnhadley.github.io/OxfordIDN_Shiny-App-Templates/advanced-shiny-features/popout-button/)
- [Optional popout button](https://martinjhnhadley.github.io/OxfordIDN_Shiny-App-Templates/advanced-shiny-features/popout-button/)

This app does *not* utilise reactive expressions to control the update order of Shiny content. If your Shiny app will include these features, you may find this tutorial useful - https://martinjhnhadley.github.io/OxfordIDN_Shiny-App-Templates/advanced-shiny-features/reactive-expressions/