...
<p>Code can be included inline using backticks, for instance here `r '\x60r 2+2\x60'` is written to compute 2+2: `r 2+2`. This is useful for providing information about the data included in the visualisation, for instance the observation that the data in this visualisation has `r nrow(locations)` rows in it.</p>
